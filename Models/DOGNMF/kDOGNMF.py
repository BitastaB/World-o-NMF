...
from Utils.utils import init_kmeans, construct_similarity_matrix, store_kmeans, KNN
...
def run_model(model, dataset, alpha_range, beta_range, matImg, matGnd, k_1_list, k_2_list, k_knn_list, maxiter_kmeans, l, max_iter,
              myeps_1, myeps_2, y):
        ...
        for k_1 in k_1_list:
            ...
            #    heat_count += 1
                for p in range(len(parameters)):
                    ...
                    matH, matV, n_iteration = DOGNMF(matX, matS, matD, m, n, l, [k_1, k_2], alpha, beta, max_iter, myeps_1, myeps_2)
